...
if pnet.parallel.main(__name__):
    ...
    firstLayerShape = 6
    #Get extract feature with first-layer parts
    ...
    #These are for visualizing first layer parts
    ...
    #Seperate coded regions (Here it is 7 by 7 region)
    ...
    #Here start the second-layer training 
    newPartsRegion = []

...
if pnet.parallel.main(__name__):
    ...
    #ims, labels = ag.io.load_cifar10("training", selection=slice(5000))

    ims_batches = np.array_split(ims, 10)
    labels_batches = np.array_split(labels, 10)

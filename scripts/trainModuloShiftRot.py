...
#    pnet.EdgeLayer(k=5, radius=1, spread='orthogonal', minimum_contrast=0.05),
    pnet.ModuloShiftingRotationPartsLayer(num_parts = 10, part_shape = (6,6),shifting_shape = (5,5),num_rot = 8,
...
digits = range(10)
ims = ag.io.load_mnist('training', selection=slice(1000), return_labels=False)
